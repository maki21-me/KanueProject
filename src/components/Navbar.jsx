    ...
    <div className="shadow-lg bg-white dark:bg-gray-900 dark:text-white duration-200 fixed w-full z-50">
      <div className="container py-3 sm:py-0 flex justify-between items-center">
        ...
        <div className="hidden sm:flex items-center gap-6">
          ...
          {/* ✅ Book & Order Button now links to /book-order */}
          <Link
            to="/book-order"
            className="bg-gradient-to-r from-primary to-secondary text-white px-5 py-2 rounded-full flex items-center gap-3 shadow-lg hover:scale-105 transition-transform duration-300 interactive"
          >
            Book & Order
      ...
      >
        ...
        <ul className="flex flex-col mt-4 p-5 gap-4">
          ...
          {/* ✅ Mobile Book & Order Link */}
          <li>
            <Link
              to="/book-order"
              className="w-full bg-gradient-to-r from-primary to-secondary text-white px-5 py-2 rounded-full flex items-center justify-center gap-3 shadow-lg hover:scale-105 transition-transform duration-300 interactive"
              onClick={() => setMobileMenuOpen(false)}
            >
              Book & Order
              <FaCartShopping className="text-xl text-white drop-shadow-sm cursor-pointer" />
