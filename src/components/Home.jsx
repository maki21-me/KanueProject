    ...
    <section className="relative w-full h-screen">
      ...
      >
        ...
        <p className="text-white sm:text-xl md:text-2xl mb-6 max-w-2xl drop-shadow-lg">
          Experience modern and traditional dishes, a place to refresh, relax,
          and enjoy unforgettable flavors.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <button
            ...
            className="bg-gradient-to-r from-primary to-secondary text-white px-6 py-3 rounded-full shadow-lg hover:scale-105 transition-transform duration-300 interactive"
          >
            Book a Table
          </button>
          <a
            href="/#menu"
            className="bg-white text-primary px-6 py-3 rounded-full shadow-lg hover:bg-primary hover:text-white transition-colors duration-300 interactive"
          >
            View Menu
          </a>
          {/* Testimonials button removed as requested */}
        </div>
      </div>
